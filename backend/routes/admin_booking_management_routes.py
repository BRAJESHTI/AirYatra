...
async def get_booking_timeline(
    ...
    if not timeline:
        timeline = [{
            ...
            "event_label": "Booking Created / बुकिंग बनाई गई",
...
async def request_booking_cancellation(
    ...
    await db.booking_timeline.insert_one({
        ...
        "event_label": "Cancellation Requested / रद्दीकरण अनुरोधित",
...
async def emergency_override_booking(
    ...
    await db.booking_timeline.insert_one({
        ...
        "event_label": "⚠️ Emergency Override / आपातकालीन ओवरराइड",
...
async def reassign_booking_extended(
    ...
    await db.booking_timeline.insert_one({
        ...
        "event_label": "Booking Reassigned / बुकिंग पुनः असाइन",
    ...
    if notify_customer:
        await db.in_app_notifications.insert_one({
            ...
            "title": "Operator Changed / ऑपरेटर बदला गया",
