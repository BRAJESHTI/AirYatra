...
def prepare_operator_notification(booking_data: dict, distance_km: float) -> dict:
    ...
    return {
        ...
        "pickup_location": booking_data.get("from_location"),
        "pickup_district": booking_data.get("from_district"),
        "pickup_state": booking_data.get("from_state"),
        "drop_location": booking_data.get("to_location"),
        "drop_district": booking_data.get("to_district"),
        "drop_state": booking_data.get("to_state"),
        "passengers": booking_data.get("passengers", 1),
        "purpose": purpose_map.get(booking_data.get("booking_purpose"), "General"),
        "trip_type": trip_type_map.get(booking_data.get("flight_type"), "One Way"),
