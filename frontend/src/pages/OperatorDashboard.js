...
import MyRoutesQuotes from '../components/operator/MyRoutesQuotes';
...
const navGroups = [
  {
    ...
    items: [
      ...
      { id: 'asre', label: 'ASRE', icon: Zap, path: '/operator/asre', highlight: true },
      { id: 'erp', label: 'ERP Command Center', icon: BarChart3, path: '/operator/erp', highlight: true },
      { id: 'revenue', label: 'Revenue Dashboard', icon: DollarSign, path: '/operator/revenue', highlight: true },
      { id: 'fleet-analytics', label: 'Fleet Analytics', icon: Plane, path: '/operator/fleet-analytics', highlight: true },
      { id: 'new-inquiries', label: 'New Inquiries', icon: Bell, path: '/operator/new-inquiries', highlight: true },
    ]
  },
  {
    id: 'business',
    ...
    icon: Briefcase,
    items: [
      { id: 'inquiries', label: 'All Inquiries', icon: MessageSquare, path: '/operator/inquiries' },
      { id: 'complaints', label: 'Complaints', icon: Flag, path: '/operator/complaints', highlight: true },
      { id: 'penalties', label: 'Penalties', icon: DollarSign, path: '/operator/penalties', highlight: true },
      { id: 'live-auctions', label: 'Live Auctions', icon: Gavel, path: '/operator/auctions', highlight: true },
      { id: 'quotes', label: 'Quote Requests', icon: DollarSign, path: '/operator/quotes', highlight: true },
      { id: 'my-routes-quotes', label: 'My Routes & Quotes', icon: DollarSign, path: '/operator/my-routes-quotes', highlight: true },
      { id: 'journey-otp', label: 'Journey OTP', icon: Key, path: '/operator/journey-otp', highlight: true },
      { id: 'cancel-bookings', label: 'Cancel Booking', icon: Ban, path: '/operator/cancel-bookings', highlight: true },
    ]
  },
  {
    id: 'fleet',
    ...
    icon: Plane,
    items: [
      { id: 'fleet', label: 'Fleet Management', icon: Plane, path: '/operator/fleet' },
      { id: 'aircraft-catalog', label: 'Aircraft Catalog', icon: Shield, path: '/operator/aircraft-catalog', highlight: true },
      { id: 'maintenance-calendar', label: 'Maintenance Calendar', icon: Calendar, path: '/operator/maintenance-calendar', highlight: true },
      { id: 'cost-tracker', label: 'Cost Tracker', icon: DollarSign, path: '/operator/cost-tracker', highlight: true },
      { id: 'pilots', label: 'Pilots', icon: Users, path: '/operator/pilots' },
      { id: 'pilot-assignment', label: 'Pilot Assignment', icon: UserPlus, path: '/operator/pilot-assignment', highlight: true },
      { id: 'crew-scheduling', label: 'Crew Scheduling', icon: Calendar, path: '/operator/crew-scheduling', highlight: true },
      { id: 'pilot-documents', label: 'Pilot Documents', icon: FileText, path: '/operator/pilot-documents', highlight: true },
    ]
  },
  {
    id: 'tracking',
    ...
    icon: Navigation,
    items: [
      { id: 'live-tracking', label: 'Live Tracking', icon: MapPin, path: '/operator/live-tracking', highlight: true },
      { id: 'pilot-duty', label: 'Pilot Duty Tracker / FDTL', icon: Shield, path: '/operator/pilot-duty', highlight: true },
      { id: 'flight-records', label: 'Flight Records', icon: BookOpen, path: '/operator/flight-records' },
      { id: 'fuel-records', label: 'Fuel Records', icon: Fuel, path: '/operator/fuel-records' },
      { id: 'landing-permissions', label: 'Landing Permissions', icon: Shield, path: '/operator/landing-permissions' },
    ]
  },
  {
    id: 'account',
    ...
    icon: User,
    items: [
      { id: 'pricing', label: 'Pricing Config', icon: DollarSign, path: '/operator/pricing', highlight: true },
      { id: 'profile', label: 'Profile', icon: User, path: '/operator/profile' },
      { id: 'settings', label: 'Settings', icon: Settings, path: '/operator/settings' },
    ]
  },
];
