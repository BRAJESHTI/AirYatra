          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://instagram.com/airyatra" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-2 rounded-lg hover:bg-slate-700 transition-colors" aria-label="Instagram">
